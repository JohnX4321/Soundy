package com.thingsenz.soundy.musicplayer.services;
...
import com.thingsenz.soundy.musicplayer.interfaces.PlayerInterface;
import com.thingsenz.soundy.musicplayer.loaders.SongLoader;
...
import com.thingsenz.soundy.utils.MusicPreference;
import com.thingsenz.soundy.utils.NotificationHandler;

import java.util.List;

public class MusicService extends Service implements MediaPlayer.OnPreparedListener,MediaPlayer.OnErrorListener,MediaPlayer.OnCompletionListener, PlayerInterface, AudioManager.OnAudioFocusChangeListener {
    ...
    public void onCreate() {
        ...
        SESSION_ID=String.valueOf(player.getAudioSessionId());
...
//                break;
    ...
    private void restoreSong() {
        ...
        if (currentSongId != 0) {
            currentSong = SongLoader.get(this).getSong(currentSongId);
        } else {
            currentSong = SongLoader.get(this).getRandomSong();
        }
    ...
    public void play(long songId) {
        player.reset();
        Song playSong = SongLoader.get(this).getSong(songId);
        play(playSong);
    }
...
//        play(currentSongPosition + 1);
        play(SongLoader.get(this).getNextSong(currentSong));
    }
...
//        play(currentSongPosition - 1);
        ...
        play(SongLoader.get(this).getPreviousSong(currentSong));

    }

    public List<Album> getAlbums() {
        return SongLoader.get(this).getAlbums();
    }

    public List<Artist> getArtists() {
        return SongLoader.get(this).getArtists();
    }

    public List<Song> getSongs() {
        return SongLoader.get(this).getSongs();
    }
