...
public class SongAdapter extends RecyclerView.Adapter<SongAdapter.ViewHolder> {
    ...
    List<Song> songs;             // for storing the current playing songs
    List<Song> filteredSongs;     // for storing the filtered songs
    List<Song> dbSongs;           // for storing the stock database songs
